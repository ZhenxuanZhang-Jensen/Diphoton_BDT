...
def train_bayes_model(events_sig, events_bkg ):
...
events_sig_UL18 = uproot.open("/hpcfs/cms/cmsgpu/zhangzhx/eos/UL2018/MassUL2018_ETSS/output_sig125_IncludeLumi.root:Sig125")
events_bkg_UL18 = uproot.open("/hpcfs/cms/cmsgpu/zhangzhx/eos/UL2018/MassUL2018_ETSS/New_MCpp_DataDriven_QCD_SFs_sEoEWgt_2DpTWgt.root")
train_bayes_model(events_sig= events_sig_UL18, events_bkg= events_bkg_UL18)
