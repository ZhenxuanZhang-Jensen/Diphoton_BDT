...
samples = "UL16_postVFP masswindow no sigmrv"
...
events_sig_UL16PostVFP = uproot.open("/hpcfs/cms/cmsgpu/zhangzhx/eos/UL2016PostVFP/Sig125_negReweighting.root:Sig125")
...
train_bayes_model(events_sig= events_sig_UL16PostVFP, events_bkg= events_bkg_UL16PostVFP, is_mass_window=True, weight_style='weight_absRatio', input_features = input_features)
