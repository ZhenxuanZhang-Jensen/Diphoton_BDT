...
samples = "UL16_preVFP masswindow no rv"
...
train_bayes_model(events_sig= events_sig_16preVFP, events_bkg= events_bkg_16preVFP, is_mass_window=True, weight_style='weight_absRatio', input_features = input_features)
