...
features=['leadmva','subleadmva','leadptom','subleadptom','leadeta','subleadeta','CosPhi','vtxprob','sigmarv','sigmawv']
...
def main(options,args):
    ...
    try:
        ...
        try:
            ...
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2018/DiphotonXGboost_afterTune_withAllSigs_bayes_lessoverfitting.pkl'
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2018/DiphotonXGboost_afterTune_withAllSigs_bayes_overfitting.pkl'
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2018/DiphotonXGboost_afterTune_withAllSigs_bayes_split.pkl'
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2018/DiphotonXGboost_afterTune_withAllSigs_bayes.pkl'
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2016/Mon_Nov_14_15:39:32UL16PostVFP_DiphotonXGboost_afterTune_new_withAllSigs.pkl'
            # file = '/eos/user/z/zhenxuan/BDT/XGboost/model/UL2016/Mon_Nov_14_14:57:26UL16PreVFP_DiphotonXGboost_afterTune_new_withAllSigs.pkl'
            file = options.inFile
