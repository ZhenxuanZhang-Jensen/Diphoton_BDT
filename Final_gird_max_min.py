...
gsearch1 = GridSearchCV(estimator = xgb.XGBClassifier( learning_rate =0.01, n_estimators=1000, max_depth=11,
 min_child_weight=10, gamma=0, subsample=1, colsample_bytree=1,
 objective= 'binary:logistic', nthread=4, scale_pos_weight=nB/nS, seed=27,tree_method='gpu_hist'), 
 param_grid = param_test7, scoring='roc_auc',n_jobs=4, cv=3)
